...
var bgImage = document.querySelector(".container");
var bgColor = document.querySelector(".index");
var text = document.querySelectorAll(".slider-list-item");

button1.addEventListener("click", function (evt) {
  evt.preventDefault();
  bgColor.classList.remove("index-slide-2");
  bgColor.classList.remove("index-slide-3");
  bgColor.classList.add("index-slide-1");
  bgImage.classList.remove("container-slide-2");
  bgImage.classList.remove("container-slide-3");
  bgImage.classList.add("container-slide-1");
...
button2.addEventListener("click", function (evt) {
  evt.preventDefault();
  bgColor.classList.remove("index-slide-1");
  bgColor.classList.remove("index-slide-3");
  bgColor.classList.add("index-slide-2");
  bgImage.classList.remove("container-slide-1");
  bgImage.classList.remove("container-slide-3");
  bgImage.classList.add("container-slide-2");
...
button3.addEventListener("click", function (evt) {
  ...
  bgColor.classList.remove("index-slide-1");
  bgColor.classList.remove("index-slide-2");
  bgColor.classList.add("index-slide-3");
  bgImage.classList.remove("container-slide-1");
  bgImage.classList.remove("container-slide-2");
  bgImage.classList.add("container-slide-3");
  text[0].classList.add("visually-hidden");
  text[1].classList.add("visually-hidden");
